            ...
            <div class="container">
                <div class="row p-b-60 p-t-60">
                    ...
                    <div class="col-md-6 text-white p-b-30">
                        <div class="media">
                            ...
                            <div class="media-body m-auto">
                                <h5 class="mt-0">Amelia Andreoiu <img src="https://twemoji.maxcdn.com/2/72x72/1f397.png"
                                                                      width="20" alt=""></h5>
                    ...
                    <div class="col-md-6 text-white my-auto text-md-right p-b-30">
                        ...
                        <div class="">
                            <p class="opacity-75"><a href="#!">480 Mutual Friends</a></p>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">
                            <div class="p-b-10 text-center">
                                <img class="rounded" src="assets/img/social/s1.png" alt="">
                            </div>
                            <p>
                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">
                            <div class="p-b-10 text-center">
                                <img class="rounded" src="assets/img/social/s2.png" alt="">
                            </div>
                            <p>
                            ...
                            <div>
                                <ul class="list-unstyled">
                                    ...
                                    <li class="media">
                                        <div class="avatar mr-3  avatar-sm">
                                            <img src="assets/img/users/user-7.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
                                        <div class="media-body">
                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">
                            <div class="p-b-10 text-center">
                                <img class="rounded" src="assets/img/social/s3.png" alt="">
                            </div>
                            <p>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="list-group list  list-group-flush">
                            ...
                            <div class="list-group-item ">
                                <i class="mdi mdi-map-marker"></i> Lives in <a href="#" class="text-underline">
                                    Boston</a>
                            </div>
                            <div class="list-group-item ">
                            ...
                            <div class="list-group-item ">
                                <i class="mdi mdi-home"></i> From <a href="#" class="text-underline"> New york,NY</a>
                            </div>
                        </div>
                    </div>
                    <div class="card m-b-30">
                        ...
                        <div class="list-group list  list-group-flush">
                            ...
                            <div class="list-group-item d-flex  align-items-center">
                                <div class="m-r-20">
                                    <div class="avatar avatar-sm ">
                                        <div class="avatar-title rounded-circle bg-success">M</div>
                                    </div>
                                </div>
                                <div class="">
                                    <div class="name">Mats Christ</div>
                            ...
                            <div class="list-group-item d-flex  align-items-center">
                                <div class="m-r-20">
                                    <div class="avatar avatar-sm ">
                                        <div class="avatar-title rounded-circle bg-warning">AD</div>
                                    </div>
                                </div>
                                <div class="">
                                    <div class="name">Anthony Dumont</div>
                                    <div class="text-muted">Human Resource</div>
                                </div>
                            ...
                            <div class="list-group-item d-flex  align-items-center">
                                <div class="m-r-20">
                                    <div class="avatar avatar-sm ">
                                        <div class="avatar-title rounded-circle bg-primary">I</div>
                                    </div>
                                </div>
                                <div class="">
                                    <div class="name">Iurie Vâlcu</div>
                            ...
                            <div class="list-group-item d-flex  align-items-center">
                                <div class="m-r-20">
                                    <div class="avatar avatar-sm ">
                                        <div class="avatar-title rounded-circle bg-primary">L</div>
                                    </div>
                                </div>
                                <div class="">
                                    <div class="name">Lelia Irimescu</div>
                            ...
                            <div class="list-group-item d-flex  align-items-center">
                                <div class="m-r-20">
                                    <div class="avatar avatar-sm "><img class="avatar-img rounded-circle"
                                                                        src="assets/img/users/user-1.jpg" alt="users"></div>
                                </div>
                                <div class="">
                            ...
                            <div class="list-group-item d-flex  align-items-center">
                                <div class="m-r-20">
                                    <div class="avatar avatar-sm "><img class="avatar-img rounded-circle"
                                                                        src="assets/img/users/user-4.jpg" alt="user4"></div>
                                </div>
                                <div class="">
                            ...
                            <div class="list-group-item d-flex  align-items-center">
                                <div class="m-r-20">
                                    <div class="avatar avatar-sm "><img class="avatar-img rounded-circle"
                                                                        src="assets/img/users/user-8.jpg" alt="user"></div>
                                </div>
                                <div class="">
