            ...
            <div class="row p-b-60 p-t-60">
                ...
                <div class="col-md-6 text-white p-b-30">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h1>Jack Tremblay</h1>
                            <div class="text-overline opacity-75">Front-end developer</div>
                            <p class="opacity-75">Working on front-end interfaces for business applications</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 text-md-right text-white">
                    <div>
                        ...
                        <a href="$" class="badge-soft-danger badge">Business Intelligence</a>
                    </div>
                    <!---
                    <p class="m-t-10">
            ...
            <div class="col-lg-4 order-1 order-lg-0 m-b-30">
                <div class="card m-b-30">
                    ...
                    <div class="list-group list  list-group-flush">
                        ...
                        <div class="list-group-item p-all-15 h6 ">
                            <i class="mdi mdi-map-marker"></i> Lives in Warsaw
                        </div>
                        <div class="list-group-item p-all-15 h6 ">
                            <i class="mdi mdi-school"></i> Studied at Northeastern University
                        </div>
                        <div class="list-group-item p-all-15 h6 ">
                            <i class="mdi mdi-home"></i> From Toronto, ON, Canada</a>
                        </div>
                    </div>
                </div>
                <div class="card m-b-30">
                        ...
                        <div class="timeline">
                                ...
                                <div class="timeline-wrapper">
                                    <div class="">
                                        <div class="avatar avatar-sm">
                                            <img class="avatar-img rounded-circle" src="assets/img/logos/stripe.jpg"
                                                    alt="">
                                        </div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="timeline-item">
                                <div class="timeline-wrapper">
                                    <div class="">
                                        <div class="avatar avatar-sm">
                                            <img class="avatar-img rounded-circle" src="assets/img/logos/google.jpg"
                                                    alt="">
                                        </div>
                                    </div>
                                    <div class="col-auto">
